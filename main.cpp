...
int main(int argc, char const *argv[])
{
    ...
    if (argc > 1)
    {
        ...
        else if (std::string(argv[1]) == "-g" || std::string(argv[1]) == "--grid")
        {
            test_colour_grid = true;
        }
        else if (std::string(argv[1]) == "-c" || std::string(argv[1]) == "--colours")
        {
            test_colours = true;
        }
        ...
        else if (std::string(argv[1]) == "-a" || std::string(argv[1]) == "--all")
        {
            test_types = true;
            test_colour_grid = true;
            test_colours = true;
    ...
    if (test_types == false && test_colour_grid == false && test_colours == false)
    {
        std::cout << "Usage: " << argv[0] << "[OPTIONS]" << std::endl;
        std::cout << "Options:" << std::endl;
        std::cout << "  -c, --colours\t\tTest text colours" << std::endl;
